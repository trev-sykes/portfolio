...
const fullArticle: FullArticle = {
    ...blogPreview,
    title: `The Evolution of DeFi: A New Financial Infrastructure`,
    sections: [
        {
            sectionTitle: `The Genesis of DeFi: Ethereum's Programmable Money Vision`,
        ...
        {
            sectionTitle: `The Evolution of Decentralized Exchange Mechanisms`,
        ...
        {
            sectionTitle: `Advanced AMM Designs and Innovations`,
        ...
        {
            sectionTitle: `The Lending Protocol Revolution`,
        ...
        {
            sectionTitle: `The Future: Cross - Chain DeFi and Innovation`,
        ...
        {
            sectionTitle: 'Conclusion: DeFi as Financial Infrastructure',
