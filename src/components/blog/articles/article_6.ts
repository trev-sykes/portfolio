...
const fullArticle: FullArticle = {
    ...
    sections: [
        {
            sectionTitle: `Understanding the Relationship Between L2s and Ethereum`,
        ...
        {
            sectionTitle: `The Role of L2s in Ethereum's Ecosystem`,
        ...
        {
            sectionTitle: 'Challenges: Fragmentation and Liquidity',
        ...
        {
            sectionTitle: `Synergies Between L1 and L2`,
        ...
        {
            sectionTitle: 'The Path Forward: Collaboration over Competition',
