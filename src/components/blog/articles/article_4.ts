...
const blogPreview: BlogPreview = {
    title: 'Feb. 2024 Crypto Market Analysis',
...
const fullArticle: FullArticle = {
    sections: [
        {
            title: 'The Transformative Start to 2024',
        ...
        {
            title: 'Institutional and Regulatory Landscape',
        ...
        {
            title: 'Future Outlook and Challenges',
...
const article_4: Blog = {
    titleHeader: 'The State of Crypto: February 2024 Market Analysis',
    ...blogPreview,
    ...fullArticle
}
