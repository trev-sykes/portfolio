...
const blogPreview: BlogPreview = {
    previewTitle: 'Develop a Platformer Game with Phaser 3',
...
const fullArticle: FullArticle = {
    ...blogPreview,
    title: 'Phaser 3 Platformer Game Tutorial',
    sections: [
        {
            sectionTitle: 'Setting Up Phaser 3',
        ...
        {
            sectionTitle: 'Creating Player Characters',
...
function collectTreasure() {
  ...
  score += 10;
        ...
        {
            sectionTitle: 'Implementing Game Mechanics',
...
function collectPowerUp() {
  ...
  this.powerUp.destroy();
        ...
        {
            sectionTitle: 'Testing and Debugging',
